	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/auth/_provider_/_server.ts.js'))
			},
			{
				...
				params: [{"name":"provider","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/auth/_provider_/callback/_server.ts.js'))
			},
			{
				id: "/documents",
				pattern: /^\/documents\/?$/,
