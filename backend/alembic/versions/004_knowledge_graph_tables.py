...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_kg_entities_entity_type_subtype",
        "kg_entities",
    ...
    op.create_index(
        "ix_kg_relationships_source", "kg_relationships", ["source_entity_id"]
    )
    op.create_index(
        "ix_kg_relationships_target", "kg_relationships", ["target_entity_id"]
    )
    op.create_index(
        "ix_kg_relationships_type", "kg_relationships", ["relationship_type"]
    )
    op.create_index(
        "ix_kg_relationships_source_type",
        "kg_relationships",
    ...
    op.create_table(
        ...
        sa.Column(
            "relationship_id",
            sa.Integer(),
            sa.ForeignKey("kg_relationships.id", ondelete="CASCADE"),
        ),
        sa.Column(
            "document_id",
            sa.Integer(),
    ...
    op.create_index(
        "ix_kg_evidence_relationship_id", "kg_evidence", ["relationship_id"]
    )
    ...
    op.create_index(
        "ix_documents_kg_extraction_status", "documents", ["kg_extraction_status"]
    )
